...
namespace lets_gooo
{
    public partial class F9_manila_to_Palawan : Form
    {
        ...
        private void F9_manila_to_Palawan_Load(object sender, EventArgs e)
        {
            dataView();
        }
