...
namespace lets_gooo
{
    public partial class F10_manila_to_Bicol : Form
    {
        ...
        private void F10_manila_to_Bicol_Load(object sender, EventArgs e)
        {
            dataView();
        }
