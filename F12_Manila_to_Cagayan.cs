...
namespace lets_gooo
{
    public partial class F12_Manila_to_Cagayan : Form
    {
        ...
        private void F12_Manila_to_Cagayan_Load(object sender, EventArgs e)
        {
            dataView();
        }
