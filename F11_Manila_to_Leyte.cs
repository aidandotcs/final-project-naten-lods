...
namespace lets_gooo
{
    public partial class F11_Manila_to_Leyte : Form
    {
        ...
        private void F11_Manila_to_Leyte_Load(object sender, EventArgs e)
        {
            dataView();
        }
