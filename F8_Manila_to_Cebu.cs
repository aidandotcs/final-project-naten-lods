...
namespace lets_gooo
{
    public partial class F8_Manila_to_Cebu : Form
    {
        ...
        private void F8_Manila_to_Cebu_Load(object sender, EventArgs e)
        {
            dataView();
        }
